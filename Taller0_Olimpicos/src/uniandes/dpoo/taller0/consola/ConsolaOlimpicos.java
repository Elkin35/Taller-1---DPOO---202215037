...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar pais al cual representa un atleta\n");
	}
	...
	private void ejecutarPaisPorAtleta() {
		System.out.println("Pais del atleta seleccionado");
		
		 String nombreAtleta = input("Por favor ingrese el nombre del atleta que desee buscar");
		 String paisAtleta = calculadora.paisPorAtleta(nombreAtleta);
		 
		 if (paisAtleta != "False") {
			 System.out.println("El atleta " + nombreAtleta + " representa al país " + paisAtleta);
		 } else {
			 System.out.println("No se encontró al atleta ingresado");
		 }
